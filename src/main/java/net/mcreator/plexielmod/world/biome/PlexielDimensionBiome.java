...
package net.mcreator.plexielmod.world.biome;
...
import net.mcreator.plexielmod.entity.PlexrabossEntity;
import net.mcreator.plexielmod.block.PlexrablockBlock;
import net.mcreator.plexielmod.PlexielmodModElements;

@PlexielmodModElements.ModElement.Tag
public class PlexielDimensionBiome extends PlexielmodModElements.ModElement {
	public static Biome biome;
	public PlexielDimensionBiome(PlexielmodModElements instance) {
		super(instance, 55);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-65536).setWaterColor(-65536).setWaterFogColor(-65536)
						...
						.setAdditionsSound(new SoundAdditionsAmbience((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("ambient.underwater.enter")), 0.0111D))
						.setMusic(new BackgroundMusicSelector((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("plexielmod:mii_challenge")), 12000, 24000, true))
						.setParticle(new ParticleEffectAmbience(ParticleTypes.CRIT, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(PlexrablockBlock.block.getDefaultState(),
								PlexrablockBlock.block.getDefaultState(), PlexrablockBlock.block.getDefaultState())));
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(PlexrabossEntity.entity, 1, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("plexielmod:plexiel_dimension"));
			}
		}
	}
	@Override
