...
public class PlexrabackpackItem extends PlexielmodModElements.ModElement {
	@ObjectHolder("plexielmod:plexrabackpack")
	public static final Item block = null;
	public PlexrabackpackItem(PlexielmodModElements instance) {
		super(instance, 85);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(OngletplexielmodItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("plexrabackpack");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Plexrabackpack");
					}
