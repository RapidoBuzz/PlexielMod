...
public class DiscoblocBlock extends PlexielmodModElements.ModElement {
	@ObjectHolder("plexielmod:discobloc")
	public static final Block block = null;
	public DiscoblocBlock(PlexielmodModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Pour la d\u00E9coration bloc par Alicia and charlie"));
		}
